...
- [2 OpenC2 Language Binding for Threat Hunting](#2-openc2-language-binding-for-threat-hunting)
  - [2.1 OpenC2 Command Components](#21-openc2-command-components)
    ...
    - [2.1.3 Type Definitions](#213-type-definitions)
        ...
        - [**Table 2.1.3-7 Timeranges Type**](#table-213-7-timeranges-type)
        - [**Table 2.1.3-8 Timerange Type**](#table-213-8-timerange-type)
        - [**Table 2.1.3-9 Absolute Timerange Type**](#table-213-9-absolute-timerange-type)
        - [**Table 2.1.3-10 timestamp Type**](#table-213-10-timestamp-type)
        - [**Table 2.1.3-11 Time-Unit Type**](#table-213-11-time-unit-type)
        - [**Table 2.1.3-12 Timerange-Rel Type**](#table-213-12-timerange-rel-type)
        - [**Table 2.1.3-13 Typed-Arguments Type**](#table-213-13-typed-arguments-type)
        - [**Table 2.1.3-14 Arg-Type Type**](#table-213-14-arg-type-type)
        - [**Table 2.1.3-15 Arg-Name Type**](#table-213-15-arg-name-type)
